...
test.describe('Service Worker Alarm Persistence', () => {
  ...
  test('should persist alarm configuration across restart', async ({ context, extensionId, serviceWorker }) => {
    // Create test alarm
  ...
  test('should maintain multiple alarms across restart', async ({ context, extensionId, serviceWorker }) => {
  ...
  test('should trigger alarm after restart', async ({ context, extensionId, serviceWorker }) => {
  ...
  test('should handle empty alarm state across restart', async ({ context, extensionId, serviceWorker }) => {
    // Verify no alarms
    const alarmsBefore = await getAllAlarmsFromSW(serviceWorker);
  ...
  test('should preserve periodic alarm timing', async ({ context, extensionId, serviceWorker }) => {
